  ...
  return (
    <div className="flex flex-col w-full h-5/6 justify-center items-center">
      ...
      <a
        ...
        className="bg-red-600 p-2 rounded-md drop-shadow-lg button-text-shadow mt-2 mx-auto w-1/6 hover:w-2/6 transition-all ease-in-out duration-300 text-center"
      >
        <Button
          text="Report"
          icon={
